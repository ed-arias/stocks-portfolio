# portfolio-history-chart Specification

## Purpose
Defines the PortfolioChart component — an interactive area line chart rendered inside the dashboard that displays portfolio total value over a selectable time window.
