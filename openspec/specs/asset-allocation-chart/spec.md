...
## Purpose
SVG donut chart component displaying portfolio breakdown by asset class (Stocks, ETFs, Crypto, Cash). Renders segments, a hover tooltip, and a color-coded legend from pre-computed backend data — no financial arithmetic in the component.
