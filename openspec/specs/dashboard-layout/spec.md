...
## Purpose
Defines the structural layout of the dashboard: sticky top bar with hero metric, two-column grid on wide viewports, responsive collapse rules, and content max-width.
