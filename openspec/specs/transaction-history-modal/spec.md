# transaction-history-modal Specification

## Purpose
Defines the behaviour of the transaction history modal: how it is triggered from the holdings table, what it displays, and how it is dismissed.
