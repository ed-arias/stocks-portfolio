# holdings-grouping Specification

## Purpose
Defines the holdings table grouping feature, introduced alongside feature 2.9 (sortable columns). Allows users to switch between a flat list and a grouped view that organises positions under collapsible asset-class section headers.
